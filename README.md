...
* calibration mode
* pixel size
* base LiteLoc train/infer YAMLs
...
calibration:
  mode: vector_beads
  base_yaml: demo/demo3_calibrate_psf/params_demo3_psf_calibration.yaml

liteloc:
  base_train_yaml: demo/demo1_astig_npc/train_params_demo1.yaml
  base_infer_yaml: demo/demo1_astig_npc/infer_params_demo1.yaml
